...
import { ParentToChildMessageGasParams, ParentToChildMessageParams } from '../message/ParentToChildMessageCreator';
/**
 ...
 * @returns
 */
export declare const isParentToChildTransactionRequest: <T>(possibleRequest: ParentToChildTransactionRequest | IsNotTransactionRequest<T>) => possibleRequest is ParentToChildTransactionRequest;
/**
 * Check if an object is of ChildToParentTransactionRequest type
 * @param possibleRequest
 * @returns
 */
export declare const isChildToParentTransactionRequest: <T>(possibleRequest: ChildToParentTransactionRequest | IsNotTransactionRequest<T>) => possibleRequest is ChildToParentTransactionRequest;
export {};
